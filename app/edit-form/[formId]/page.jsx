...
const EditForm = ({ params }) => {
    ...
    const updateJsonFormInDb = async () => {
        ...
        toast('Your field has been updated!')
        console.log(result);
    }
    ...
    const updateControllerFields = async (value, columnName) => {
        ...
        toast('Your style has been updated!')
    }
    ...
    return (
        <div className='p-10'>
            <div className='flex justify-between items-center'>
                <h2
                    className='flex gap-2 items-center my-5 cursor-pointer hover:scale-105 transition-all'
                    onClick={() => router.back()}
                >
                    <ArrowLeft /> Back
                </h2>
            ...
            <div className='grid grid-cols-1 md:grid-cols-3 gap-5'>
                ...
                <div
                    className='md:col-span-2 border rounded-lg p-5 flex items-center justify-center shadow-lg'
